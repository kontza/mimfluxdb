...
func newCount(db *gorm.DB, opts ...gen.DOOption) count {
	...
	_count.DeviceID = field.NewInt64(tableName, "device_id")
	_count.RecordedAt = field.NewTime(tableName, "recorded_at")
	_count.Value = field.NewInt32(tableName, "value")
...
func (c *count) updateTableName(table string) *count {
	...
	c.DeviceID = field.NewInt64(table, "device_id")
	c.RecordedAt = field.NewTime(table, "recorded_at")
...
func (c *count) WithContext(ctx context.Context) *countDo { return c.countDo.WithContext(ctx) }
...
func (c *count) fillFieldMap() {
	...
	c.fieldMap["recorded_at"] = c.RecordedAt
...
func (c countDo) Debug() *countDo {
	return c.withDO(c.DO.Debug())
}

func (c countDo) WithContext(ctx context.Context) *countDo {
	return c.withDO(c.DO.WithContext(ctx))
}

func (c countDo) ReadDB() *countDo {
	return c.Clauses(dbresolver.Read)
}

func (c countDo) WriteDB() *countDo {
	return c.Clauses(dbresolver.Write)
}

func (c countDo) Session(config *gorm.Session) *countDo {
	return c.withDO(c.DO.Session(config))
}

func (c countDo) Clauses(conds ...clause.Expression) *countDo {
	return c.withDO(c.DO.Clauses(conds...))
}

func (c countDo) Returning(value interface{}, columns ...string) *countDo {
	return c.withDO(c.DO.Returning(value, columns...))
}

func (c countDo) Not(conds ...gen.Condition) *countDo {
	return c.withDO(c.DO.Not(conds...))
}

func (c countDo) Or(conds ...gen.Condition) *countDo {
	return c.withDO(c.DO.Or(conds...))
}

func (c countDo) Select(conds ...field.Expr) *countDo {
	return c.withDO(c.DO.Select(conds...))
}

func (c countDo) Where(conds ...gen.Condition) *countDo {
	return c.withDO(c.DO.Where(conds...))
}

func (c countDo) Order(conds ...field.Expr) *countDo {
	return c.withDO(c.DO.Order(conds...))
}

func (c countDo) Distinct(cols ...field.Expr) *countDo {
	return c.withDO(c.DO.Distinct(cols...))
}

func (c countDo) Omit(cols ...field.Expr) *countDo {
	return c.withDO(c.DO.Omit(cols...))
}

func (c countDo) Join(table schema.Tabler, on ...field.Expr) *countDo {
	return c.withDO(c.DO.Join(table, on...))
}

func (c countDo) LeftJoin(table schema.Tabler, on ...field.Expr) *countDo {
	return c.withDO(c.DO.LeftJoin(table, on...))
}

func (c countDo) RightJoin(table schema.Tabler, on ...field.Expr) *countDo {
	return c.withDO(c.DO.RightJoin(table, on...))
}

func (c countDo) Group(cols ...field.Expr) *countDo {
	return c.withDO(c.DO.Group(cols...))
}

func (c countDo) Having(conds ...gen.Condition) *countDo {
	return c.withDO(c.DO.Having(conds...))
}

func (c countDo) Limit(limit int) *countDo {
	return c.withDO(c.DO.Limit(limit))
}

func (c countDo) Offset(offset int) *countDo {
	return c.withDO(c.DO.Offset(offset))
}

func (c countDo) Scopes(funcs ...func(gen.Dao) gen.Dao) *countDo {
	return c.withDO(c.DO.Scopes(funcs...))
}

func (c countDo) Unscoped() *countDo {
...
func (c countDo) Attrs(attrs ...field.AssignExpr) *countDo {
	return c.withDO(c.DO.Attrs(attrs...))
}

func (c countDo) Assign(attrs ...field.AssignExpr) *countDo {
	return c.withDO(c.DO.Assign(attrs...))
}

func (c countDo) Joins(fields ...field.RelationField) *countDo {
...
func (c countDo) Preload(fields ...field.RelationField) *countDo {
	for _, _f := range fields {
